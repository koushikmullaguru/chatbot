...
def send_message(
    ...
    ai_response_content = "This is a placeholder AI response. In a real implementation, this would be generated by an AI service."
    ...
    ai_message = Message(
        ...
        sender_type="ai",
        suggested_questions=["What is the main topic?", "Can you explain this in more detail?"]
    )
    db.add(ai_message)
    db.commit()
